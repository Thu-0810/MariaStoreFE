...
import { getMyCommissionsApi, checkoutCommissionApi } from "../../../api/commissionApi";
...
export default function ProfileRequestsPage() {
  ...
  const fetchMy = async () => {
    const res = await getMyCommissionsApi();
    ...
    <>
      ...
      {selected && (
        <CommissionDetailModal
          ...
          onPay={(payload) => checkoutCommissionApi(selected.id, payload).then((r) => r.data)}
          onPaidSuccess={fetchMy}
        />
      )}
    </>
  );
